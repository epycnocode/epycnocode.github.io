...
document.querySelector("form").addEventListener("submit", function (event) {
    ...
    var doneMsg = document.querySelector(".done-msg");
    ...
    .then(data => {
        if (data === "success") {
            ...
            doneMsg.textContent = "Error sending message. Please try again.";
            doneMsg.style.color = "red";
        }
    })
    .catch(error => {
        console.error("Error:", error);
        doneMsg.textContent = "An unexpected error occurred. Please try again later.";
        doneMsg.style.color = "red";
    });
});
